  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      const ctx = gsap.context(() => {
        // Title and subtitle animations - with null checks
        const elements = [];
        ...
        // Form animation - with null check
        if (formRef.current) {
        ...
        // Contact cards animations - filter out null refs
        ...
        // Social icons animations - filter out null refs
        ...
        // Footer animation - with null check
