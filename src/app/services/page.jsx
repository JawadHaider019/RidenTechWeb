...
const services = [
  ...
  },
  {
    ...
    fallbackImage: "https://images.pexels.com/photos/6054883/pexels-photo-6054883.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1571781418606-70265b9cce90?q=80&w=2065&auto=format&fit=crop",
  ...
  },
  {
    ...
    fallbackImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop",
...
export default function ServicesPage() {
  ...
  const handleCardClick = (serviceTitle, serviceId) => {
    // Navigate to contact page with service name and id as query parameters
    window.location.href = `/contact?service=${encodeURIComponent(serviceTitle)}&id=${serviceId}`;
  };
            ...
            <div key={category} className="mb-12 last:mb-0">
              ...
              <div className="flex flex-col gap-4 md:gap-5 lg:gap-6">
                {categoryServices.map((service, index) => {
                  ...
                  return (
                    <div
                      id={service.id} // ADD THIS LINE - gives the div an ID for scrolling
                      key={service.id}
                      ...
                      <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                        ...
                        <div className="card-content w-full lg:w-7/12 p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 flex flex-col justify-center bg-white">
                          ...
                          <div className="flex flex-col sm:flex-row items-start sm:items-center pt-4">
                            <Link
                              href={`/contact?service=${encodeURIComponent(service.title)}&id=${service.id}`}
